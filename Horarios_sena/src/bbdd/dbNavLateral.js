export const dbNavLateral = [
    { id : '1' , logo :'fa-solid fa-user', texto : 'INSTRUCTOR'},
    { id : '2' , logo :'fa-solid fa-book', texto : 'TEMATICA'  },
    { id : '3' , logo :'fa-solid fa-users', texto : 'FICHA'},
    { id : '4' , logo :'fa-solid fa-tv', texto : 'PROGRAMA'},
...
export const dbInstructores = [
    ...
    { id : '3', userName : 'elonmusk', nombre: 'Elon Musk', info : 'Instructor de marketing digital'},
